<template>
  <div class="reinstall-detail" :class="`theme-hardware`">
    ...
    <SystemReinstallTable />
  </div>
</template>

<script setup lang="ts">
import { useRouter } from 'vue-router'
import SystemReinstallTable from '@/components/SystemReinstallTable.vue'
...
.reinstall-detail :deep(.task-board) {
  max-width: 1000px;
  margin: 0 auto;
}
